...
file_get_contents("https://api.telegram.org/bot$token/sendphoto?chat_id=$chat_id&photo=$img&parse_mode=HTML&caption=$welcome");
}

if (strpos($send, "/help") === 0) {

$help = urlencode("<b>\xF0\x9F\x92\x89 Sri Lanka Covid 19 Stats Bot \xF0\x9F\x92\x89</b>\n\n\xE3\x80\xBD <b>About Bot</b> \xE3\x80\xBD\n\n<b>\xE2\x96\xB6	Name</b> - Sri Lanka Covid 19 Stats Bot\n<b>\xE2\x96\xB6	Username</b> - @srilankacovid19statsbot\n<b>\xE2\x96\xB6	Created By</b> - @hirunaofficial\n\n<b>\xF0\x9F\x94\xA7 Bot Commands \xF0\x9F\x94\xA7</b>\n\n\xE2\x96\xB6	/start - What is Sri Lanka Covid 19 Stats Bot\n\xE2\x96\xB6	/covid /corona - Get Local and Globle Covid 19 Informations\n\xE2\x96\xB6	/help - More information about Sri Lanka Covid 19 Stats Bot\n\n<b>\xE2\x9E\x95 Add Bot to Your Group \xE2\x9E\x95</b>\n\n\xE2\x96\xB6	You need to add Sri Lanka Covid 19 Bot to Your Group First go to your Group and Go to Add Members Section Type @srilankacovid19statsbot and Select Bot Now you are Successfully added Sri lanka Covid 19 Stats Bot to your group now you can get all about Covid 19 Information using type /covid or /corona");

file_get_contents("https://api.telegram.org/bot$token/sendphoto?chat_id=$chat_id&photo=$img&parse_mode=HTML&caption=$help");
}
